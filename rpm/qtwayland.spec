...
Name:           qt5-qtwayland-custom_egl
Summary:        Qt Wayland compositor, custom_egl variant
...
.
This package contains the Qt wayland compositor for custom_egl
...
mobile and embedded systems without rewriting the source code.
.
This package contains the Qt wayland compositor development files for custom_egl
...
mobile and embedded systems without rewriting the source code.
.
This package contains the Qt wayland compositor examples for custom_egl
...
export QT_WAYLAND_GL_CONFIG=custom_egl
touch .git
